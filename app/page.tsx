    ...
    <main className="min-h-screen bg-slate-50 text-slate-900">
      <nav className="border-b border-slate-200 bg-white">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-5">
          ...
          <div className="flex items-center gap-2">
            <Link href="/login" className="rounded-lg px-3 py-2 text-sm font-semibold text-slate-700 hover:text-indigo-600">Log in</Link>
      ...
      <section className="mx-auto max-w-4xl px-6 py-28 text-center">
        ...
        <div className="mt-10 flex flex-wrap justify-center gap-4">
          ...
          <Link href="/typing-test" className="rounded-xl border border-slate-300 bg-white px-7 py-4 font-semibold text-slate-700 hover:bg-slate-50">Practice now</Link>
        </div>
